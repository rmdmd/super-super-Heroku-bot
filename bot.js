...
if (message.content.startsWith('help')){
  ...
  .setColor("random")
  .addField(" **help:**" , " ** bc1- للبروتكاست , clear- لمسح الشات مع الرقم , kick- لطرد العضو , ban- لتبنيد العضو **")
...
client.login('NDM2NDY3NTM3MDg2MjUxMDA4.DfF8zw.j5QDms6TrfiQ5oiRoPBKpC6QbAk');
